...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Process_Box.setMinimumSize(QtCore.QSize(280, 520))
        ...
        self.Pos_Shift_SpinBox.setDecimals(2)
        ...
        self.Neg_Scale_SpinBox.setDecimals(2)
        self.Neg_Scale_SpinBox.setProperty("value", 1.0)
        self.Neg_Scale_SpinBox.setMaximum(999.99)
        ...
        self.Neg_Shift_SpinBox.setDecimals(2)
    ...
    def transChineseSimplified(self):
        self.langText = {"Data List":"数据列表","Smooth Methods":"滤波方法","Skip Interval":"采点间隔","Skip":"采点","Diff Interval":"微分间隔","Diff":"微分","Smooth Parameter":"滤波参数","Smooth":"滤波","Date Type":"数据类型","Positive":"正极","Negative":"负极","FullCell":"全电池","Scale":"缩放","Shift":"平移","Fitting":"拟合","Cut From":"切割 从","To":"到","Cut":"切割","&File":"文件","&Open":"打开","&Recent Files":"最近打开","&Edit":"编辑","&Data":"数据","&Tool":"工具","&Help":"帮助","&Language":"语言","&Save":"保存","&Save As":"另存为","&Preferences":"首选项","&Exit":"退出","Positive Reference":"正极参考数据","Negative Reference":"负极参考数据","Measured Data":"测试数据","Excel2TXT":"Excel转TXT","Excel2CSV":"Excel转CSV","CSV2TXT":"CSV转TXT","CSV2Excel":"CSV转Excel","TXT2CSV":"TXT转CSV","TXT2Excel":"TXT转Excel","&Delete":"删除","&View":"查看","&Swap Axes":"转置","&Rename":"重命名","&Export":"导出","&Delete All":"删除全部","&English":"英语","&Chinese Simplified":"简体中文","&Chinese Traditional":"繁体中文","&Email":"电子邮箱"
        ,"Smooth Window":"滤波窗口","Noise Factor":"噪声因子","Sigma":"标准差","Data Rename":"数据重命名","Please input new data name:":"请输入新的数据名：","Information":"消息","Critical":"错误警告","Warning":"警告","No data selcted!":"没有选中的数据！","Save File":"保存文件","Please select a data file":"请选择一个数据文件","Invalid Data File!":"不是合法的数据文件！","A error occur, please contact author for help!":"未知错误，请联系作者！","Save AECA Project File":"保存AECA项目文件","Save AECA project file successful!":"保存AECA项目文件成功！","Please contact author: WangC7@ATLBattery.com":"请联系软件作者：WangC7@ATLBattery.com"," is not an invalid AECA project file!":"不是合法的AECA项目文件！","&Export Results":"导出拟合结果","&View Results":"查看拟合结果","&Import Results":"导入拟合结果","Save statistic data file":"保存统计数据文件","Export statistic data file successful!":"导出统计数据文件成功！","&User Guide":"用户手册","Do you want to replace current project file?":"是否替换当前项目文件？","DO you need to save current project file?":"是否保存当前项目文件？"}
        self.retranslateUI()

    def transChineseTraditional(self):
        self.langText = {"Data List":"數據列表","Smooth Methods":"濾波方法","Skip Interval":"采點間隔","Skip":"采點","Diff Interval":"微分間隔","Diff":"微分","Smooth Parameter":"濾波參數","Smooth":"濾波","Date Type":"數據類型","Positive":"正極","Negative":"負極","FullCell":"全電池","Scale":"縮放","Shift":"平移","Fitting":"擬合","Cut From":"切割 從","To":"到","Cut":"切割","&File":"文件","&Open":"打開","&Recent Files":"最近打開","&Edit":"編輯","&Data":"數據","&Tool":"工具","&Help":"幫助","&Language":"語言","&Save":"保存","&Save As":"另存為","&Preferences":"首選項","&Exit":"退出","Positive Reference":"正極參考數據","Negative Reference":"負極參考數據","Measured Data":"測試數據","Excel2TXT":"Excel轉TXT","Excel2CSV":"Excel轉CSV","CSV2TXT":"CSV轉TXT","CSV2Excel":"CSV轉Excel","TXT2CSV":"TXT轉CSV","TXT2Excel":"TXT轉Excel","&Delete":"刪除","&View":"查看","&Swap Axes":"轉置","&Rename":"重命名","&Export":"導出","&Delete All":"刪除全部","&English":"英語","&Chinese Simplified":"簡體中文","&Chinese Traditional":"繁體中文","&Email":"電子郵箱"
        ,"Smooth Window":"濾波窗口","Noise Factor":"噪聲因子","Sigma":"標準差","Data Rename":"數據重命名","Please input new data name:":"請輸入新的數據名：","Information":"消息","Critical":"錯誤警告","Warning":"警告","No data selcted!":"沒有選中的數據！","Save File":"保存文件","Please select a data file":"請選擇壹個數據文件","Invalid Data File!":"不是合法的數據文件！","A error occur, please contact author for help!":"未知錯誤，請聯系作者！","Save AECA Project File":"保存AECA項目文件","Save AECA project file successful!":"保存AECA項目文件成功！","Please contact author: WangC7@ATLBattery.com":"請聯系軟件作者：WangC7@ATLBattery.com"," is not an invalid AECA project file!":"不是合法的AECA項目文件！","&Export Results":"導出擬合結果","&View Results":"查看擬合結果","&Import Results":"導入擬合結果","Save statistic data file":"保存統計數據文件","Export statistic data file successful!":"導出統計數據文件成功！","&User Guide":"用戶手冊","Do you want to replace current project file?":"是否替換當前項目文件？","DO you need to save current project file?":"是否保存當前項目文件？"}
        self.retranslateUI()
