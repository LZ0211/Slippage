...
class Preference(QWidget):
    ...
    def tab4UI(self):
        ...
        MaxPoints = QSpinBox()
        MaxPoints.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        MaxPoints.setMaximum(1E5)
        SuffixCut = QLineEdit()
        ...
        layout.addRow(QLabel(self.translate('Generation in Capacity Range')),UseMaxCapacity)
        layout.addRow(QLabel(self.translate('Maximum Capacity')),MaxCapacity)
        layout.addRow(QLabel(self.translate('Generation Points Count')),MaxPoints)
        ...
        UseMaxCapacity.setValue(int(self.defaultSetting('Core/UseMaxCapacity',0)))
        MaxPoints.setValue(int(self.defaultSetting('Core/MaxPoints',500)))
        ...
        UseMaxCapacity.valueChanged.connect(hotfix('UseMaxCapacity'))
        MaxPoints.valueChanged.connect(hotfix('MaxPoints'))
